...
The following is a tsibble (a special type of tibble containing time series data, which we will see more of later), stored in the variable `mauna`, of CO$_2$ concentrations collected monthly at the Mauna Loa station.
...
ggplot(mauna, aes(y = month)) +
  geom_line(aes(y = cO2 Concentrations))
```
